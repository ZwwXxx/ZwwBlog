<template>
    <div class="publishBoard" v-show="!$store.state.loading">
        <div class="publish-board-title tada_parent">
            <svg t="1706692323623" class="icon tada" viewBox="0 0 1024 1024" version="1.1"
                 xmlns="http://www.w3.org/2000/svg" p-id="6000" width="25" height="25">
                <path d="M837.8 375.1H186.3c-16.5 0-30 13.5-30 30v404.6c0 16.5 13.5 30 30 30h651.4c16.5 0 30-13.5 30.1-30V405.1c0-16.5-13.5-30-30-30z m-35.9 377.5H215v-8h586.9v8z m0-20H215v-8h586.9v8z"
                      fill="#5097FF" p-id="6001"></path>
                <path d="M787.3 887.9H781c-8.3 0-15 6.7-15 15s6.7 15 15 15h6.3c8.3 0 15-6.7 15-15s-6.8-15-15-15z"
                      fill="#06265B" p-id="6002"></path>
...
export default {
    ...
    data() {
        return {
            publish: [
                {publishType: 'p-line', content: '--本站域名--'},
    ...
    methods:{
        gotoLink(board) {
            if (board.publishType === "a-link") {
                window.open(board.linkUrl);
            }
        },
    }
}
...
.publish-board-title p {
    margin-left: 5px;
    font-weight: bolder;
}

.publish-board-content {
    padding: 10px;
}
